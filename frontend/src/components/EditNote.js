...
const EditNote = () => {
    ...
    useEffect(() => {
        const fetchNote = async () => {
            try {
                const response = await axios.get(`https://tugas6-backend-171192151600.us-central1.run.app/notes/${id}`);
    ...
    const updateNote = async (e) => {
        ...
        try {
            const response = await axios.put(`https://tugas6-backend-171192151600.us-central1.run.app/notes/${id}`, updatedData);
